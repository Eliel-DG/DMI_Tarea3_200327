...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: ' Tarea3_200327', // Título de la aplicación.
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('TAREA 3: 200327',
            style: TextStyle(color: Color.fromARGB(255, 48, 47, 47))),
        backgroundColor: Color.fromARGB(255, 74, 163, 179),
      ),
      body: Container(
        color: Color.fromARGB(255, 57, 100, 136), // Cambia el fondo del body a azul.
        child: Center(
              ...
              children: <Widget>[
                Center(
                  child: Container(
                    ...
                    child: Text(
                      'TAREA 3 200327 :Estilización y uso de Fuentes',
                      style: TextStyle(
                        fontFamily:
                            'Wash', // Usa el nombre de tu fuente personalizada.
                ...
                Image.asset(
                  'assets/image.jpg', //  ruta de la imagen.
